...
public class ParkingLotTest {
    ...
    public void itShouldReturnOccupationPercentage() {
        ...
        assertEquals(parkingLot.calculateAvailabilityPercentage(), 1d, DELTA);
    }

    @Test
    public void itShouldReturnOccupationPercentageForHalfOccupation() {
        var parkingLot = new ParkingLot(1,10,5);
        assertEquals(parkingLot.calculateAvailabilityPercentage(), 0.5d, DELTA);
    }
    ...
    public void itShouldDecreaseTheAvailableSpotsInOneUnit() {
        ...
        assertEquals(parkingLot.calculateAvailabilityPercentage(), 0.4d, DELTA);
    }
